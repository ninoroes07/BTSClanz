...
Contoh: !say FERO, ID GENSHIN MU APA?!?!?!

🐼 _*!lirik*_ <penyanyi-judul lagu>
_${BotName}_🍄akan mengirimkanmu lirik lagu yang kamu inginkan
contoh : !lirik Rick Astley-Never Gonna Give You Up

🐼 _*!alay*_ <teks>
_${BotName}_🍄akan mengubah teks yang kamu kirimkan menjadi alay
contoh : !alay Kenneth Wacth Hentai


☪*Others*☪

🐼 _*#row1*_
_${BotName}_🍄akan mengirimkan daftar command berkaitan dengan bot

Penggunaan 	: #row1
Contoh		: Prefix ini berbeda dengan yang lain

🐼 _*#row2*_
_${BotName}_🍄akan mengirimkanmu daftar command berkaitan tentang fun games
...
• TELEGRAM : ${telegram}
• Youtube : •Pixel Craft Gaming•
• WA : 081214165112
• Pasang Iklan? Chat Whatsapp.

📺 *IKLAN* : *Subscribe: •Pixel Craft Gaming•*
